              ...
              <div className="relative grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
                ...
                <div>
                  ...
                  <h1 className="md:text-5xl/tight my-4 max-w-lg text-4xl font-medium text-white">
                    Now Create Solana token to Without code</h1>
                  <p className="text-default-300 md:text-lg">
                    Launch your solan token, All in one solana token development and deployment
                  </p>
                  <div className="new_add_css">
                    <a onClick={() => setOpenCreateModal(true)} className="hover:bg-primary-hover pe-4 group mt-10 inline-flex items-center justify-center gap-2 rounded-full border border-white/10 px-1 py-1 text-white transition-all duration-300">
                      <span className="bg-priamry/20 text-primary me-2 flex h-11 w-11 items-center justify-center rounded-full group-hover:bg-white/10 group-hover:text-white ">
                        <i data-luice="image">
                          <MdGeneratingTokens />
                        </i></span>
                    </a>
                      ...
                      <div className="marquee-hero flex min-h-full flex-shrink-0 flex-col items-center justify-around gap-6">
                        {
                          ["img-9",
                            ...
                            <img key={ind} src={`assets/images/ai/${img}.jpg`} alt="ai images" className="aspect-1 h-full w-60 rounded-xl object-cover" />
                          ))
                        }
                      </div>
                      <div aria-hidden="true" className="marquee-hero flex min-h-full flex-shrink-0 flex-col items-center justify-center gap-6">
                      {
                          ["img-9",
                            "img-14",
                            "img-21",
