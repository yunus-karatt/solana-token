  ...
  const features = [
    {
      ...
      description:
        "Start working with solana token creator, It allow you to create solan token by creating , deploying, airdrop, transfering and updating token",
        ...
        <div className="mb-10 flex items-end justify-between">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="text-default-200 text-sm font-medium">
              Now you can create solan token <br />
